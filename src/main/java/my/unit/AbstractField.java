...
import my.unit.field.BarracksField;
import my.unit.field.BuildingField;
import my.unit.field.CapitalField;
import my.unit.field.CommercialField;
import my.unit.field.ContinentalField;
import my.unit.field.FarmField;
import my.unit.field.Fortification;
import my.unit.field.FortressField;
import my.unit.field.GrassField;
import my.unit.field.MeadowField;
import my.unit.field.MineField;
import my.unit.field.MountainsField;
import my.unit.field.NaturalField;
import my.unit.field.PlainsField;
import my.unit.field.PropertyField;
import my.unit.field.SeaField;
import my.unit.field.ShipyardField;
import my.unit.field.Spawner;
import my.unit.field.TownField;
import my.unit.field.VillageField;
...
public abstract class AbstractField
{
    ...
    void setEntity(AbstractEntity newEntity)
    {
        entity = newEntity;
    }
